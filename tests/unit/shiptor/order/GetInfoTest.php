...
class shiptorOrderGetInfoTest extends getInfoTest {
            ...
            "result": 
                {
                    ...
                    "external_id": "' . $obj['info']['SenderInvoiceNumber'] . '",
                    "stock": 1,
                    "status": "' . $obj['status']['State'] . '",
                    "tracking_number": "RP744171",
                    "external_tracking_number": null,
                    "created_at": "' . $obj['info']['CreateDate'] . '",
                    "weight": 1,
                    "length": 10,
                    "width": 10,
                    "height": 10,
                    "cod": 1000,
                    "declared_cost": ' . $obj['info']['Sum'] . ',
                    "no_gather": false,
